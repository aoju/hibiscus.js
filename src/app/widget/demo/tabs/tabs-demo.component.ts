...
export class TabsDemoComponent {
  ...
  tabA = [
    ...
    },
    {
      ...
      icon: 'icmn-users',
      title: 'Profile',
      content: `Food truck fixie locavore, accusamus mcsweeney's marfa nulla
    ...
    },
    {
      ...
      icon: 'icmn-cog',
      title: 'Fat',
      content: `Etsy mixtape wayfarers, ethical wes anderson tofu before they sold
