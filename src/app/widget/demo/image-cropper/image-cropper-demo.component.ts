...
import {ImageCropperComponent, ImageCropperSettings, CropperPosition} from '../../../exports/image-cropper/index';
...
export class ImageCropperDemoComponent {
  ...
  // Cropper 1 data
  public data1: any;
  public cropperSettings1: ImageCropperSettings;

  // Cropper 2 data
  public data2: any;
  public cropperSettings2: ImageCropperSettings;
  ...
  // Cropper 3 data
  public data3: any;
  public cropperSettings3: ImageCropperSettings;
  public cropPosition: CropperPosition;

  // Cropper 4 data
  public cropperSettings4: ImageCropperSettings;
  ...
  constructor() {
    ...
    this.cropperSettings1 = new ImageCropperSettings();
    ...
    // Cropper settings 2
    this.cropperSettings2 = new ImageCropperSettings();
    ...
    // Cropper settings 3
    this.cropperSettings3 = new ImageCropperSettings();
    ...
    this.cropperSettings3.resampleFn = (buffer: HTMLCanvasElement) => {
      ...
      let canvasContext = buffer.getContext('2d');
      let imgW = buffer.width;
      let imgH = buffer.height;
    ...
    this.cropPosition = new CropperPosition();
    ...
    // Cropper settings 4
    this.cropperSettings4 = new ImageCropperSettings();
    ...
    this.updateCropPosition = () => {
      this.cropPosition = new CropperPosition(this.cropPosition.x, this.cropPosition.y, this.cropPosition.w, this.cropPosition.h);
    };
