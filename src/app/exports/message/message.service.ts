...
export class MessageBaseService<ContainerClass extends MessageContainerComponent, MessageData, MessageConfig1 extends MessageConfig> {
  ...
  config(config: MessageConfig1): void {
...
@Injectable()
export class MessageService extends MessageBaseService<MessageContainerComponent, MessageData, MessageConfig> {
  ...
  create(type: 'success' | 'info' | 'warning' | 'error' | 'loading' | string, content: string, options?: MessageDataOptions): MessageDataFilled {
