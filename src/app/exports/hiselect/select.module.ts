...
import {HiSelectComponent} from './select.component';

@NgModule({
  imports: [CommonModule, FormsModule, OverlayModule],
  declarations: [OptionComponent, HiSelectComponent, OptionContainerComponent, OptionGroupComponent, OptionLiComponent, SelectTopControlComponent, SelectUnselectableDirective, ContainerPipe, OptionPipe, SubOptionPipe],
  exports: [OptionComponent, HiSelectComponent, OptionContainerComponent, OptionGroupComponent, SelectTopControlComponent]
})
