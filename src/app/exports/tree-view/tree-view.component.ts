...
export class TreeViewComponent {
  ...
  constructor(hiNGConfig: HiNGConfig, private treeViewService: TreeViewService) {
    this.valueField = hiNGConfig.treeView.valueField;
    this.textField = hiNGConfig.treeView.textField;
    this.leafIcon = hiNGConfig.treeView.leafIcon;
    this.expendIcon = hiNGConfig.treeView.expendIcon;
    this.collapseIcon = hiNGConfig.treeView.collapseIcon;
    this.loadingIcon = hiNGConfig.treeView.loadingIcon;
  }
