...
export class CarouselComponent implements AfterContentInit, OnDestroy {
  ...
  constructor(private  renderer: Renderer2, private hiNGConfig: HiNGConfig) {
    this.reflowDuration = hiNGConfig.carousel.reflowDuration;
    this.animationDuration = hiNGConfig.carousel.animationDuration;
    this.animate = hiNGConfig.carousel.animate;
    this.interval = hiNGConfig.carousel.interval;
  }
