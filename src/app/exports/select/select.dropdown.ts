...
import {ChangeDetectionStrategy, Component, ElementRef, EventEmitter, HostListener, Inject, Input, NgZone, OnChanges, OnDestroy, OnInit, Optional, Output, Renderer2, SimpleChanges, TemplateRef, ViewChild, ViewEncapsulation} from '@angular/core';
import {animationFrameScheduler, asapScheduler, fromEvent, merge, Subject} from 'rxjs';
import {auditTime, takeUntil} from 'rxjs/operators';
import {NgOption, PanelDimensions, SelectService} from './select.service';

import {DropdownPosition} from './select.component';
import {isDefined} from './select.utils';

const TOP_CSS_CLASS = 'hi-select-top';
const BOTTOM_CSS_CLASS = 'hi-select-bottom';
...
export class SelectDropdown implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private _panelService: SelectService,
