...
export class PaginationComponent implements OnChanges {
  ...
  constructor(hiNGConfig: HiNGConfig) {
    this.boundary = hiNGConfig.pagination.boundary;
    this.pageSize = hiNGConfig.pagination.pageSize;
    this.maxItems = hiNGConfig.pagination.maxItems;
    this.firstLink = hiNGConfig.pagination.button.first;
    this.lastLink = hiNGConfig.pagination.button.last;
    this.preLink = hiNGConfig.pagination.button.pre;
    this.nextLink = hiNGConfig.pagination.button.next;
    this.firstLinkCssClass = hiNGConfig.pagination.button.firstLinkCssClass;
    this.preLinkCssClass = hiNGConfig.pagination.button.preLinkCssClass;
    this.nextLinkCssClass = hiNGConfig.pagination.button.nextLinkCssClass;
    this.lastLinkCssClass = hiNGConfig.pagination.button.lastLinkCssClass;
    this.size = <any>hiNGConfig.pagination.size;
  }
