...
export class DatePickerDirective implements OnInit, ControlValueAccessor, OnDestroy {
  ...
  constructor(private elementRef: ElementRef, private viewContainerRef: ViewContainerRef,
              ...
              private hiNGConfig: HiNGConfig) {

    this.dateConfig = hiNGConfig.datePicker;
    this.dateConverter = hiNGConfig.datePicker.dateConverter || new DefaultDateConverter();
    this.showTimePicker = hiNGConfig.datePicker.timePicker;
    this.locale = hiNGConfig.datePicker.locale;
  ...
  ngOnInit() {
    ...
    const viewContainerRef = this.appendBody ? this.hiNGConfig.rootContainer : this.viewContainerRef;
